   ...
   <div class="row-fluid"> 
    <div class="col-md-12"> 
     ...
     <ul class="nav nav-tabs"> 
      ...
      <li> <a id="myList" href="MyList.php">&nbsp;&nbsp;<i class="glyphicon glyphicon-list"></i>&nbsp;我的题单&nbsp;&nbsp;&nbsp;</a> </li> 
      <li> <a id="rankList" href="mylist_rank_chosen.php">&nbsp;&nbsp;<i class="glyphicon glyphicon-sort-by-order"></i>&nbsp;排行榜&nbsp;&nbsp;</a> </li> 
      <li> <a id="atMe" href="atme.php">&nbsp;&nbsp;<i class="glyphicon glyphicon-tasks"></i>&nbsp;@我的&nbsp;&nbsp;&nbsp;</a> </li> 
     ...
     <div class="row-fluid"> 
      ...
      <div class="col-md-10" style="text-align:center;"> 
       <form action="submit.php?uid=<?php echo $_REQUEST['uid']; ?>" method="post"> 
        <fieldset id="qlist"> 
         <legend> 题单名：<input name="qname" type="text" class="form-control" style="margin:0px 20% 0px;width:60%;" /> </legend> 
         <div class="row"> 
          <div class="col-md-3"> 
           <ol> 
            <li>选择题点选中的答案为正确答案，选择题最多只能点选一个答案。如果不小心点了两个及以上的答案，以ABCD的优先顺序选取唯一答案</li> 
            <li>出于对题单本身质量的考虑，题单最多包括5道题。</li> 
           </ol> 
          </div> 
          <div class="col-md-6"> 
           <!--选择题样式
