...
var button3click = '<a href="#" class="radiobutton1">选择题</a>&nbsp;<a href="#" class="radiobutton2">填空题</a>&nbsp;<a href="#" class="radiobutton3 choose">主观题</a><form name="Second" action="sub.php" method="post"><input type="hidden" name="type" value="c" />问题：<input name="Ans_nam"></input><br />回答：<input name="Ans_text"></input><div><button type="submit">提交</button></div></form><!--  主观题 -->';
</script> 
<!--<script>
